        ...
        <form @submit.prevent="submitForm">
          <div class="row">
            <div class="col-xs-6 col-md-6">
              ...
              <date-picker :title="birthday" v-model="emp.birthday" :default="getDate(emp.birthday)"/>
              <div class="form-group">
            ...
            <div class="col-xs-6 col-md-6">
              ...
              <date-picker :title="joinAt" v-model="emp.joined_at" :default="getDate(emp.joined_at)"/>
              <date-picker :title="confirmAt" v-model="emp.confirmed_at" :default="getDate(emp.confirmed_at)"/>
              <div class="form-group">
