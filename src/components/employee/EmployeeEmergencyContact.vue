<template>
  <div class="card">
    <div class="card-body">
      ...
      <data-table :getData="getEmergencyContacts" ref="datatable">
        <template slot="head">
          <th>Tên Nhân viên</th>
          <th>Người liên hệ</th>
          <th>Mối quan hệ</th>
        ...
        <template slot="body" slot-scope="props">
          <tr>
            <td v-text="props.item.name"
                ...
                v-bind:rowspan="props.item.employee.count_contact"/>
      ...
      <emergency-contact-modal :contact="user_contact" :is-create="isCreate" :emp-id="empId" v-if="isShow"></emergency-contact-modal>
    </div>
  </div>
</template>
