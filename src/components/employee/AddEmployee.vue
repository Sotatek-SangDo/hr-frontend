        ...
        <form @submit.prevent="submitForm">
          <div class="row">
            <div class="col-xs-6 col-md-6">
              ...
              <date-picker :title="birthday" v-model="emp.birthday" :default="getDate(emp.birthday)" v-if="isShow"></date-picker>
              <div class="form-group">
            ...
            <div class="col-xs-6 col-md-6">
              ...
              <date-picker :title="joinAt" v-model="emp.joined_at" :default="getDate(emp.joined_at)" v-if="isShow"></date-picker>
              <date-picker :title="confirmAt" v-model="emp.confirmed_at" :default="getDate(emp.confirmed_at)" v-if="isShow"></date-picker>
              <div class="form-group">
