<template>
  <div class="card">
    <div class="card-body">
      ...
      <data-table ref="datatable" :get-data="getECertifications">
        <template slot="head">
          <th>Tên Nhân viên</th>
          <th>Chứng chỉ</th>
          <th>Ngày cấp</th>
        ...
        <template slot="body" slot-scope="props">
          <tr>
            <td
              ...
              :rowspan="props.item.employee.count_certification"
      ...
      <certification-modal v-if="isShow" :certification="user_certification" :is-create="isCreate" :emp-id="empId"/>
    </div>
  </div>
</template>
